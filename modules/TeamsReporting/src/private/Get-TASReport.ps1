function Get-TASReport {
    ...
    if ($NextCursor) {
        $QueryHash['nextCursor'] = $NextCursor
    }
    ...
    if ($Response) {
        ...
        if ($Response.paging) {
            $PSBoundParameters['NextCursor'] = $Response.paging.nextCursor
            $PSBoundParameters.Remove('Key') | Out-Null
            $PSBoundParameters.Remove('Route') | Out-Null
            $PSBoundParameters.Remove('Command') | Out-Null
            $PSBoundParameters.Remove('Paginated') | Out-Null
